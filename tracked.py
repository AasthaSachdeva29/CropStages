...
crop_stages = {
    "गेहूं (Wheat)": [
        {"stage": "  0 : बीज स्थापना |   बीज मिट्टी के नीचे है", "days": [0,7]},
    ...
    "धान (Rice)":[
        {"stage": "  1 : अंकुरण और रोपाई स्थापना (Germination & Seeding Establishment)	बीज अंकुरित होता है, जड़ें विकसित होती हैं, और रोपाई खेत में स्थापित हो जाती है।", "days": [0,30]},
...
# Add the link below the progress line
    display_output_in_box2("<b>आपकी फसल की सेहत जानना चाहते हैं? तो <a href='http://127.0.0.1:7860/' style='text-decoration: underline; color: blue;' target='_blank'>यहां क्लिक करें।</b></a>")
...
# Check if the current stage is stage 8
if current_stage_index is not None and current_stage_index == len(stages) - 1:
    # Display the line
    display_output_in_box2("<span style='color:black;'><b>अपने कार्बन फुटप्रिंट की गणना करने के लिए, <a href='http://localhost:8502/' style='text-decoration: underline; color: blue;' target='_blank'>यहां क्लिक करें। </b></a>.</span>")